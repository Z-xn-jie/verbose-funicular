...
import com.sprout.MyApp;
import com.sprout.bean.IChooserModel;
import com.sprout.bean.ITagBean;
import com.sprout.photodraweeview.OnPhotoTapListener;
import com.sprout.photodraweeview.PhotoTagDraweeView;
...
public class ImagePagerAdapterForPublish extends PagerAdapter {
    ...
    private PhotoTagDraweeView instantiateImageItem(ViewGroup container,
       ...
       /* Glide.with(MyApp.myApp).load(Uri.parse(mediaModel.getId())).into(photoView)*/
        photoView.setImageURI(Uri.parse(mediaModel.getId()));
